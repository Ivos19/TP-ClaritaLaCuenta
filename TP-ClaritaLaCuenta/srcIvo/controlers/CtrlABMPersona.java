...
public class CtrlABMPersona {
	...
	public Persona getByUser(Persona p) throws Exception
	{		
		return dataPer.getLogedUser(p);
	}

	public Persona getById(int int1) throws Exception {
		return dataPer.getById(int1);
	}
}
